...
import androidx.compose.material3.Card // Para un mejor diseño de los ítems
import androidx.compose.material3.CardDefaults // Para personalizar la Card
...
fun LazyColumnExample(modifier:Modifier=Modifier) {
    val items = (1..1000).map { i ->
        ListItemData(i, "Título $i", "Descripción $i")
    }
    LazyColumn(
